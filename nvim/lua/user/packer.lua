...
packer.startup(function(use)
  ...
  use { "tzachar/cmp-tabnine", run = "./install.sh", commit = "5a6d58badbfed69ee285983bf2cf5a17d957483a" }
  ...
  use { 'jose-elias-alvarez/null-ls.nvim', commit = "f1add2302e6a01531a007c51054392d2029dbed4" } -- Use Neovim as a language server to inject LSP diagnostics, code actions, and more via Lua. Depends on plenary
  use { "RRethy/vim-illuminate", commit = "0603e75fc4ecde1ee5a1b2fc8106ed6704f34d14" } -- highlights occurrencies of current hovered word
